...
import 'package:appqlbanhang/ui/products/salesinfo_manager.dart';
        ...
        child: Consumer<AuthManager>(
          builder: (ctx, authManager, child) {
            return MaterialApp(
              ...
              // home: const ManagerProductsScreen(),
              routes: {
                ...
                ManagerRevenuesScreen.routeName: (ctx) =>
                    const ManagerRevenuesScreen(),
                NotificationsOverviewScreen.routeName: (ctx) =>
